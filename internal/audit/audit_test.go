...
func TestAuditEvent_JSON(t *testing.T) {
	event := AuditEvent{
		...
		PeerInfo:  security.PeerInfo{PID: 12345, Path: "/usr/bin/test"},
...
func TestLogger_LogAccessDecision(t *testing.T) {
	...
	peerInfo := security.PeerInfo{PID: 456, Path: "/usr/bin/kubectl"}
...
func TestIntegrityManager_SignAndVerify(t *testing.T) {
	...
	event := AuditEvent{
		Event:     "TEST_SIGNING",
		Decision:  "TEST",
		PeerInfo:  security.PeerInfo{PID: 789, Path: "/usr/bin/test"},
...
func TestAuditLogRotation(t *testing.T) {
	...
	event := AuditEvent{
		Event:    "ROTATION_TEST",
		Decision: "SUCCESS",
		PeerInfo: security.PeerInfo{PID: 999, Path: "/usr/bin/rotation-test"},
	}
...
func BenchmarkLogger_LogEvent(b *testing.B) {
	...
	event := AuditEvent{
		...
		Decision:  "ALLOW",
		PeerInfo:  security.PeerInfo{PID: 123, Path: "/usr/bin/benchmark"},
		Reference: "op://vault/item/field",
