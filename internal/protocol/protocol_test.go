...
func TestStatus(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: `{"backend":"opcli","version":"v0.5.0","uptime_seconds":3600,"cache_size":10,"hits":100,"misses":50,"in_flight":2,"ttl_seconds":300,"socket_path":"/tmp/op-authd.sock","policy_path":"/etc/opx/policy.json","policy_rule_count":5}`,
		},
		{
			name: "fake backend",
			status: Status{
			...
			expected: `{"backend":"fake","version":"v0.5.0","uptime_seconds":120,"cache_size":0,"hits":0,"misses":0,"in_flight":0,"ttl_seconds":600,"socket_path":"/var/run/op-authd.sock","policy_rule_count":0}`,
		},
		{
			name: "zero values",
			status: Status{
			...
			expected: `{"backend":"","version":"","uptime_seconds":0,"cache_size":0,"hits":0,"misses":0,"in_flight":0,"ttl_seconds":0,"socket_path":"","policy_rule_count":0}`,
		},
	}
